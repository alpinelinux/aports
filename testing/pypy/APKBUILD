...
url="https://github.com/HorridBro/AlpinePyPy"
arch="all"
license="MIT"
depends="libressl libcrypto1.0 libffi libbz2"
...
check(){
	cd "$builddir/lib-python/2.7/test/"
	# XXX: Some tests fail because they are implemented using CPython C functions
	$builddir/pypy/goal/pypy-c regrtest.py -q || true
}
