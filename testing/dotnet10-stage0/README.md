...
## Generated packages
* `dotnet10` (empty package to go around `buildrepo` build ordering bug)
* `dotnet10-stage0-bootstrap` (packages binary bootstrap artifacts)
* `dotnet10-stage0-artifacts` (packages non-binary bootstrap artifacts)
...
is required to package runtime bits from dotnet10-runtime. dotnet10-runtime only
