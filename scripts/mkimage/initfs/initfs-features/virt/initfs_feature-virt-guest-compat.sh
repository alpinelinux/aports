initfs_feature_virt_guest_drivers_compat_all() { return 0 ; }

_initfs_feature_virt_guest_drivers_compat_all_modules() {
	_initfs_feature_virt_guest_drivers_compat_net_modules
	_initfs_feature_virt_guest_drivers_compat_ata_modules
	_initfs_feature_virt_guest_drivers_compat_scsi_modules
}


initfs_feature_virt_guest_drivers_compat_net() { return 0 ; }
...
initfs_feature_virt_guest_drivers_compat_ata() { return 0 ; }
...
initfs_feature_virt_guest_drivers_compat_scsi() { return 0 ; }
