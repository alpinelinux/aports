...
## Generated packages
* `dotnet10-sdk`
* `dotnet10-sdk-aot` (required for aot compilation)
* `dotnet10-templates` (required by sdk)
...
6. Commit the changes to the git repo in a git branch
    ...
    - `git commit -m 'community/dotnet10-sdk: descriptive description'`
    - `git push`
...
7. Commit the changes to the git repo in a git branch.
    ...
    - `git add` any new patches
    - `git remove` any now-unnecessary patches
    - `git commit -m 'community/dotnet10-sdk: upgrade to <new-version>`
    - `git push`
